...
(function (window, document, undefined) {
            ...
            if ("ActiveXObject" in window) {
              ...
              if ($ele.css("box-sizing") === "border-box") {
                IEFixValue =
                  ...
                  parseFloat(
                    $ele.css(
                      "padding-" + (name === "width" ? "right" : "bottom")
                    )
                  );
              }
            }
        ...
        eventName.split(" ").forEach(function (event) {
          ...
          var callFn = function (e, ele) {
            var result = func.apply(
              ele,
              e._data === undefined ? [e] : [e].concat(e._data)
            );
            if (result === false) {
              e.preventDefault();
              e.stopPropagation();
  ...
  var CollapsePrivate = (function () {
    ...
    Collapse.prototype.open = function (item) {
      ...
      if (_this.options.accordion) {
        _this.$collapse
          .children("." + _this.classes.itemOpen)
          .each(function () {
            var $tmpItem = $(this);
  ...
  (function () {
    ...
    var inputEvent = function (e) {
      ...
      if ((event === "input" || event === "blur") && !domLoadedEvent) {
        if (input.validity) {
          $textField[input.validity.valid ? "removeClass" : "addClass"](
  ...
  mdui.Tooltip = (function () {
    ...
    function Tooltip(selector, opts) {
      ...
      _this.$tooltip = $(
        '<div class="mdui-tooltip" id="mdui-tooltip-' +
          guid +
          '">' +
  ...
  (function () {
    ...
    function Snackbar(opts) {
      ...
      _this.$snackbar
        ...
        .css(
          "left",
          (document.body.clientWidth - _this.$snackbar[0].clientWidth) / 2 +
            "px"
        )
    ...
    Snackbar.prototype.open = function () {
      ...
      // 开始打开
      _this.state = "opening";
      _this.$snackbar.transform("translateY(0)").transitionEnd(function () {
  ...
  mdui.Menu = (function () {
    ...
    Menu.prototype.close = function () {
      ...
      _this.$menu.removeClass("mdui-menu-open").transitionEnd(function () {
        transitionEnd(_this);
      });
    };
